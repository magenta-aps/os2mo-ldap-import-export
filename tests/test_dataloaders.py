...
@pytest.mark.parametrize(
    "obj",
    [
        gen_employee("4", givenname="Monto", surname="Gazlowe"),
    ],
)
async def test_create_each_type(
    graphql_mock: GraphQLMocker, dataloader: DataLoader, obj: MOBase
) -> None:
    create_uuid = uuid4()

    route = graphql_mock.query("employee_create")
    route.result = {"employee_create": {"uuid": create_uuid}}
